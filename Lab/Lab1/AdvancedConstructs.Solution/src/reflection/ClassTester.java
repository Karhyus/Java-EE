...
public class ClassTester {
  ...
  public static <T> void testClass(Class<T> clazz, String testName, int ord) {
  ...
  public static void main(String[] args) {
    ...
    testClass(TestClass.class, "", 1);

    System.out.println("executing test \"test1\":");
    testClass(TestClass.class, "test1", 2);

    System.out.println("executing test \"test2\":");
    testClass(TestClass.class, "test2", 0);
